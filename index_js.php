...
<!-- Main jumbotron for a primary marketing message or call to action -->
    <div class="jumbotron">
      <div id="main_info" class="container">
        <p> Привет! Здесь можно узнать сколько времени вы провели онлайн вконтакте <?php echo $myOnlineHistiry->get_correct_date($_GET['d']); ?> или в <a href="u?users=[339229,749972,42606657]&d=24.02.15">любую другую дату</a>.
