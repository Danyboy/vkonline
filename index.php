      ...
      <div id="main_info_overwiev">
       ...
       ">
          ...
          <a
            ...
            href="c?u=<?php echo $myOnlineHistiry->get_current_id($_GET['u']); ?>&cu=<?php echo $myOnlineHistiry->get_current_id($_GET['u']); ?>">совместимости
            <img src='img/heart.png' alt='$row[2]'></a>
        </p>
      </div>
